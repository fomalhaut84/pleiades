...
**현재 상태: 방향 확정 · 단계 0 미착수 · 단계 1(1a) 착수 대기.**
...
1a 착수 전 남은 것: **Q20**(두 저장소 하네스를 pleiades 로 통합 — 004 가 **선결 조건**으로 판정, 이슈 #1) ·
...
| 파일 | 내용 | 언제 읽나 |
|---|---|---|
| `docs/handoff/` 의 최신 파일 | 직전 세션 인계 노트 (`ls docs/handoff/` 로 최신 파일을 확인한다) | **새 세션 시작 시 먼저** |
...
| 2026-09-04 | `.claude/rules/workflow.md` 신설 (스킬 7 로) · worktree 배치 반영 · Codex 리뷰 10라운드 정정 | 룰·스킬·에이전트 전체 | 두 저장소 룰 계승 (#5) · 004 배치 |

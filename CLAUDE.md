...
**현재 상태: 방향 확정 · 배치·룰 완료 · 하네스 통합(#1) 집행 · **1a-0 집행 중(#31)** — 하네스 PR 5개(#19·#20·#22·#24·#26) · myFinance#492 · myFitness#369 전부 머지됨(2026-09-07). 남은 것 H-1(Q41) · H-3(fit) · 단계 0 미착수.**
...
1a 착수 전 남은 것 — **단계별로 무엇이 막는지는 `003` §10-1 의존 지도가 정본이다** (1a-0 은 **집행 중 #31** — Q47·Q44·Q46 확정 · **Q45(서버 https·node)는 1a-3 착수 전 측정** · 1a-2 는 **#1 + Q16·Q17·Q18** · 1a-1·1a-3·1a-4 는 Q10 외 다수):
...
| `docs/specs/003-notify-package.md` | **단계 1 상세 설계** — `@pleiades/notify`. 확정된 답 Q15·Q9·Q8·Q11 · **Q47(배포 형태 ALT-d)·Q44(검증 경로 γ+β2)·Q46(검증용 봇 토큰)·Q28 소멸**, 발견 8~15, L3 인터페이스, 1a-0~1a-4 · 1b, 되돌리기 표, **§10-1 의 병행 인스턴스 10조건(정본)**, 미결 **Q45**(서버 https — 1a-3 전) | **단계 1 작업 시.** 002 를 대체하지 않는다 |
